...
SRCS = main.c \
		...
		$(addprefix execute/, heredoc_expand.c redirects.c find_command_path.c parse_and_exec.c exec_pipes.c exec_without_pipes.c heredocs.c) \
		$(addprefix parsing/, syntax_helper.c check_syntax.c tokenize.c expand_variables.c is_builtin.c parse_cmds.c has_unclosed_quotes.c expand_token_helpers.c tokenize_helpers.c) \
